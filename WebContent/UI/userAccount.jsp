					...
					<form class="form-horizontal" role="form" action="UpdateUserServlet" name="updateUser" method="post">
						...
						<div class="col-md-8 col-sm-6 col-xs-12">
							<div class="form-group">
								<label class="col-lg-3 control-label"><h3>个人信息</h3></label> 
							</div>
							<div class="form-group">
							...
							<div class="form-group">
								...
								<div class="col-lg-5">
									...
									<a class="btn btn-primary btn-lg" style="float:right" data-toggle="modal" data-target="#changPassword">修改密码</a>
								</div>
							</div>
							<div class="form-group">
