...
! function (a) {
    ...
    b.DEFAULTS = {
        initOnClick: !1,
        pluginsEnabled: null
    }, b.MODULES = {}, b.PLUGINS = {}, b.VERSION = "2.1.0", b.INSTANCES = [], b.ID = 0, b.prototype._init = function () {
        var b = this.$original_element.prop("tagName"),
            ...
            e = a.proxy(function () {
                this.$el = this.$original_element, this.$el.attr("contenteditable", !0).css("outline", "none").css("display", "inline-block"), this.opts.multiLine = !1, this.opts.toolbarInline = !1, this.$original_element.trigger("froala.doInit")
            }, this),
            f = a.proxy(function () {
        ...
        function f(a) {
            ...
            }), b.opts.htmlRemoveTags.indexOf("script") >= 0 && (a = a.replace(/<script\b[^<]*(?:(?!<\/script>)<[^<]*)*<\/script>/gi, "")), a = a.replace(/<img((?:[\w\W]*?)) data-fr-src="/g, '<img$1 src="')
        }
        ...
        function p(c, d, e, f) {
            ...
            return i.push("data-fr-.*"), i.push("fr-.*"), u = new RegExp("^" + h.join("$|^") + "$", "gi"), w = new RegExp("^" + i.join("$|^") + "$", "gi"), v = new RegExp("^" + b.opts.htmlRemoveTags.join("$|^") + "$", "gi"), c = j(c, n, !0)
        }
        ...
        function g() {
            ...
            var d, e;
            do {
                e = !1, d = b.$el.get(0).querySelectorAll("*:empty:not(" + c.join("):not(") + "):not(.fr-marker)");
                for (var f = 0; f < d.length; f++)(0 === d[f].attributes.length || "undefined" != typeof d[f].getAttribute("href")) && (a(d[f]).remove(), e = !0);
                d = b.$el.get(0).querySelectorAll("*:empty:not(" + c.join("):not(") + "):not(.fr-marker)")
            } while (d.length && e)
        }
        ...
        function k(b) {
            d(b).not("hr").filter(function () {
                return "false" != a(this).attr("contenteditable") && 0 == a(this).find("br").length
            }).append("<br/>")
        }
        ...
        function p(c) {
            if ("undefined" == typeof c && (c = b.$el.get(0)), c.nodeType == Node.ELEMENT_NODE && ["STYLE", "SCRIPT", "HEAD"].indexOf(c.tagName) < 0) {
                ...
                var i = c.textContent;
                i = i.replace(new RegExp(a.FroalaEditor.UNICODE_NBSP, "g"), " ");
                for (var j = "", k = 0; k < i.length; k++) j += 32 != i.charCodeAt(k) || 0 !== k && 32 != j.charCodeAt(k - 1) ? i[k] : a.FroalaEditor.UNICODE_NBSP;
                if (c.nextSibling || (j = j.replace(/ $/, a.FroalaEditor.UNICODE_NBSP)), c.previousSibling && !b.node.isVoid(c.previousSibling) && (j = j.replace(/^\u00A0([^ $])/, " $1")), j = j.replace(/([^ \u00A0])\u00A0([^ \u00A0])/g, "$1 $2"), c.textContent != j) return !0
            }
            return !1
        }
        ...
        function z(a, c) {
            ...
            if (!b.opts.useClasses && !c) {
                for (e = 0; e < b.document.styleSheets.length; e++) {
                    var i, j = 0;
                    try {
                        i = b.document.styleSheets[e].cssRules, b.document.styleSheets[e].ownerNode && "STYLE" == b.document.styleSheets[e].ownerNode.nodeType && (j = 1)
                    } catch (k) {}
                    if (i)
                        for (var l = 0, m = i.length; m > l; l++) {
                            ...
                            if (i[l].selectorText && 0 === i[l].selectorText.indexOf(n) && i[l].style.cssText.length > 0)
                                for (var o = i[l].selectorText.replace(n, "").replace(/::/g, ":"), p = b.$el.get(0).querySelectorAll(o), q = 0; q < p.length; q++) {
                                    !p[q].getAttribute("fr-original-style") && p[q].getAttribute("style") && (p[q].setAttribute("fr-original-style", p[q].getAttribute("style")), g.push(p[q])), h[p[q]] || (h[p[q]] = {});
                                    for (var r = 1e3 * j + f(i[l].selectorText), t = i[l].style.cssText.split(";"), u = 0; u < t.length; u++) {
                                        var v = t[u].trim().split(":")[0];
                                        h[p[q]][v] || (h[p[q]][v] = 0, p[q].style[v] && (h[p[q]][v] = 1e4)), r >= h[p[q]][v] && (h[p[q]][v] = r, p[q].style[v] = t[u].trim().split(":")[1])
                                    }
                                }
                        }
                }
            ...
            if (b.core.isEmpty() ? b.opts.fullPage && (d = s(b.iframe_document), d += "<html" + b.node.attributes(b.$html.get(0)) + ">" + b.$html.html() + "</html>") : ("undefined" == typeof a && (a = !1), b.opts.fullPage ? (d = s(b.iframe_document), d += "<html" + b.node.attributes(b.$html.get(0)) + ">" + b.$html.html() + "</html>") : d = b.$el.html()), !b.opts.useClasses && !c)
                for (e = 0; e < g.length; e++) g[e].getAttribute("fr-original-class") && (g[e].setAttribute("class", g[e].getAttribute("fr-original-class")), g[e].removeAttribute("fr-original-class")), g[e].setAttribute("style", g[e].getAttribute("fr-original-style")), g[e].removeAttribute("fr-original-style");
        ...
        function E(c, d) {
            ...
            if (e = d ? c : b.clean.html(c), c.indexOf('class="fr-marker"') < 0 && (e = C(e)), b.core.isEmpty()) b.$el.html(e);
                ...
                if (B(e) && (f = b.node.deepestParent(g)))
...
//        }
            ...
            if (b.selection.isCollapsed() && b.document.queryCommandState(c) === !1) {
                ...
                if (b.selection.isCollapsed() && b.document.queryCommandState(c) === !0 && f.tagName == d.toUpperCase() && 0 === (f.textContent || "").replace(/\u200B/g, "").length) a(f).replaceWith(a.FroalaEditor.MARKERS), b.selection.restore();
                    ...
                    var g = b.$el.find("span"),
                        h = !1;
                    b.document.queryCommandState(c) !== !1 || b.browser.chrome || (b.selection.save(),
                        h = !0), b.document.execCommand(c, !1, !1), h && b.selection.restore();
        ...
        function i(c, d) {
            if (b.selection.isCollapsed()) {
                ...
                for (var i, j = function (b) {
                    ...
                    var o = m.parentsUntil(b.$el, "span").filter(k);
                    if (o.length) {
                        var p = "",
                            q = "",
                            r = "",
        ...
        function c() {
            if (b.helpers.isIOS()) {
                ...
                if (!c && !d) {
                    ...
                    b.events.disableBlur(), b.selection.save(), b.$el.blur(), b.selection.restore(), b.events.enableBlur(), a(b.original_window).scrollTop(e)
                }
            }
        }
        ...
        function h(c) {
            if (b.browser.mozilla) {
                ...
                var d = b.$el.find(".fr-marker").get(0),
                    e = d.previousSibling,
                    f = d.nextSibling;
                !f && d.parentNode && "A" == d.parentNode.tagName ? (a(d).parent().after("&nbsp;" + a.FroalaEditor.MARKERS), a(d).remove()) : (e && e.nodeType == Node.TEXT_NODE && 1 == e.textContent.length && 160 == e.textContent.charCodeAt(0) ? a(e).after(" ") : a(d).before("&nbsp;"), a(d).replaceWith(a.FroalaEditor.MARKERS)), b.selection.restore()
            }
        }
        ...
        function q(c) {
            ...
            for (var f = 0; f < e.length; f++) {
                ...
                j && l && "BR" != j.tagName && !b.node.isBlock(j) && !k && a(l).text().replace(/\u200B/g, "").length > 0 && a(j).text().length > 0 && (b.selection.save(), a(i).remove(), b.selection.restore())
            }
            var m = function (b) {
                    if (!b) return !1;
                    var c = a(b).html();
                ...
                n = b.selection.element();
            m(n) && 0 === a(n).find("li").length && !a(n).hasClass("fr-marker") && "IFRAME" != n.tagName && (b.selection.save(), o(b.node.contents(n)), b.selection.restore()), !b.browser.mozilla && b.html.doNormalize() && (b.selection.save(), b.html.normalizeSpaces(), b.selection.restore())
        }
        ...
        function e() {
            b.selection.save(), b.events.disableBlur(), o = null, p ? p.html("") : (p = a('<div contenteditable="true" style="position: fixed; top: 0; left: -9999px; height: 100%; width: 0; z-index: 9999; line-height: 140%;" tabindex="-1"></div>'),
                b.$box.after(p)), p.focus(), b.window.setTimeout(h, 1)
        }
        ...
        function d(c, d) {
            ...
            0 > e && (e = 0), e + b.$tooltip.outerWidth() > a(b.original_window).width() && (e = a(b.original_window).width() - b.$tooltip.outerWidth()), "undefined" == typeof d && (d = b.opts.toolbarBottom);
            var f = d ? c.offset().top - b.$tooltip.height() : c.offset().top + c.outerHeight();
            b.opts.iframe && (e += b.$iframe.offset().left - a(b.original_window).scrollLeft(), f += b.$iframe.offset().top - a(b.original_window).scrollTop()), b.$tooltip.css("left", e), b.$tooltip.css("top", f)
        }
        ...
        function h(c) {
            ...
            if (b.core.hasFocus() || b.$tb.find("input:visible:focus").length > 0) {
                ...
                j != f && j != g && (clearTimeout(d.data("sticky-timeout")), d.data("sticky-scheduled", j), d.outerHeight() < i - b.$tb.parent().offset().top && d.addClass("fr-opacity-0"), d.data("sticky-timeout", setTimeout(function () {
                    ...
                    e > 0 && "BODY" == b.$tb.parent().get(0).tagName && (e += b.$tb.parent().position().top), e != f && (d.css("top", Math.max(e, 0)), b.$tb.hasClass("fr-inline") && d.css("top", i), d.data("sticky-top", e), d.data("sticky-scheduled", e)), d.removeClass("fr-opacity-0"), b.$tb.hasClass("fr-inline") && b.toolbar.show()
                }, 100))), e || (d.css("top", "0"), d.width(b.$tb.parent().width()), d.addClass("fr-sticky-on"), b.$box.addClass("fr-sticky-box"))
            } else clearTimeout(a(c).css("sticky-timeout")), d.css("top", "0"), d.css("position", ""), d.width(""), d.data("sticky-top", 0), d.removeClass("fr-sticky-on"), b.$box.removeClass("fr-sticky-box"), b.$tb.hasClass("fr-inline") && b.toolbar.hide()
        }
        ...
        function q(c, d) {
            ...
            b.opts.theme && g.addClass(b.opts.theme + "-theme"), b.opts.zIndex > 1 && b.$tb.css("z-index", b.opts.zIndex + 2),
                "auto" != b.opts.direction && g.removeClass("fr-ltr fr-rtl").addClass("fr-" + b.opts.direction), g.find("input, textarea").attr("dir", b.opts.direction).attr("disabled", "disabled");
            var i = a("body");
