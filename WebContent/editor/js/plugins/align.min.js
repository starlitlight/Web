...
! function (a) {
    ...
    "use strict";
    a.FroalaEditor.PLUGINS.align = function (b) {
        function c(c) {
            b.selection.save(), b.html.wrap(!0, !0, !0), b.selection.restore();
            for (var d = b.selection.blocks(), e = 0; e < d.length; e++) a(d[e]).css("text-align", c).removeClass("fr-temp-div"), "" === a(d[e]).attr("class") && a(d[e]).removeAttr("class");
    ...
    }, a.FroalaEditor.DefineIcon("align", {
        NAME: "align-left"
        ...
        NAME: "align-justify"
    }), a.FroalaEditor.RegisterCommand("align", {
        type: "dropdown",
        title: "对齐",
        options: {
            left: "Align Left",
        ...
        html: function () {
            var b = '<ul class="fr-dropdown-list">',
                c = a.FroalaEditor.COMMANDS.align.options;
            for (var d in c) b += '<li><a class="fr-command fr-title" data-cmd="align" data-param1="' + d + '" title="' + this.language.translate(c[d]) + '">' + this.icon.create("align-" + d) + "</a></li>";
            return b += "</ul>"
        },
