...
! function (a) {
    ...
    a.extend(a.FroalaEditor.DEFAULTS, {
        ...
        fontSizeSelection: !1
    }), a.FroalaEditor.PLUGINS.fontSize = function (b) {
        function c(a) {
            b.commands.applyProperty("font-size", a + "px")
        }

        function d(c, d) {
            var e = b.helpers.getPX(a(b.selection.element()).css("font-size"));
    ...
    }, a.FroalaEditor.RegisterCommand("fontSize", {
        type: "dropdown",
        title: "字号",
        ...
        defaultSelection: "12",
        html: function () {
            for (var a = '<ul class="fr-dropdown-list">', b = this.opts.fontSize, c = 0; c < b.length; c++) {
                var d = b[c];
                a += '<li><a class="fr-command" data-cmd="fontSize" data-param1="' + d + '" title="' + d + '">' + d + "</a></li>"
            }
            return a += "</ul>"
        },
        ...
        plugin: "fontSize"
    }), a.FroalaEditor.DefineIcon("fontSize", {
        NAME: "text-height"
    })
});