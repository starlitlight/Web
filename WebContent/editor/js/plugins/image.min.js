...
! function (a) {
    ...
    a.extend(a.FroalaEditor.POPUP_TEMPLATES, {
        ...
        //imageUploadURL: "/iFilmo/FileUploadServlet",
        ...
        function F() {
            ...
            var e = b.opts.imageInsertButtons.indexOf("imageUpload"),
                ...
                h = "";
            e >= 0 && (a = " fr-active", g >= 0 && e > g && (a = ""), h = '<div class="fr-image-upload-layer' + a + ' fr-layer" id="fr-image-upload-layer-' + b.id + '"><strong>' + b.language.translate("拖动图片") + "</strong><br>(" + b.language.translate("或者点击") + ')<div class="fr-form"><input type="file" accept="image/*" tabIndex="-1"></div></div>');
            var i = "";
