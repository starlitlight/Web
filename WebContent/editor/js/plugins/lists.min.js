...
! function (a) {
    ...
    "use strict";
    a.FroalaEditor.PLUGINS.lists = function (b) {
        function c(a) {
        ...
        function j(c, d) {
            ...
            if (e.get(0) != b.$el.get(0)) {
                var f = e.get(0);
                "LI" != f.tagName && (f = e.parents("li").get(0)), f && f.parentNode.tagName == d && b.$el.get(0).contains(f.parentNode) && c.addClass("fr-active")
            }
        }
        ...
        function n() {
            b.events.on("commands.after", m), b.events.on("keydown", function (c) {
                if (c.which == a.FroalaEditor.KEYCODE.TAB) {
                    for (var d, e = b.selection.blocks(), f = [], g = 0; g < e.length; g++) "LI" == e[g].tagName ? (d = !0, f.push(e[g])) : "LI" == e[g].parentNode.tagName && (d = !0, f.push(e[g].parentNode));
                    if (d) return c.preventDefault(), c.stopPropagation(), c.shiftKey ? l(f) : k(f), !1
                }
            }, !0)
        }
        return {
    ...
    }, a.FroalaEditor.RegisterCommand("formatUL", {
        title: "非序列",
        refresh: function (a) {
        ...
        plugin: "lists"
    }), a.FroalaEditor.RegisterCommand("formatOL", {
        title: "序列",
        refresh: function (a) {
        ...
        plugin: "lists"
    }), a.FroalaEditor.DefineIcon("formatUL", {
        NAME: "list-ul"
    }), a.FroalaEditor.DefineIcon("formatOL", {
        NAME: "list-ol"
    })
});