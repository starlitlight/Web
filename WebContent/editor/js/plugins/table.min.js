...
! function (a) {
    ...
    a.extend(a.FroalaEditor.POPUP_TEMPLATES, {
        ...
        function f() {
            0 === b.$el.get(0).querySelectorAll(".fr-selected-cell").length && b.toolbar.enable()
        }
        ...
        function p() {
            ...
            if (c.length > 0)
                ...
                else if (c.remove(), b.$el.find(".fr-selected-cell").length > 0) d();
            else {
                        ...
                        for (d = 0; d < g.length; d++)
                            if (0 === d || g[d][e] != g[d - 1][e])
                                if (f = a(g[d][e]), parseInt(f.attr("colspan"), 10) > 1) {
                                    ...
                                    1 == k ? f.removeAttr("colspan") : f.attr("colspan", k), f.css("width", ((f.data("old-width") - Y(e, g)) * j / i).toFixed(4) + "%"), f.removeData("old-width")
                                } else {
        ...
        function u() {
            if (b.$el.find(".fr-selected-cell").length > 1 && (0 === b.$el.find("th.fr-selected-cell").length || 0 === b.$el.find("td.fr-selected-cell").length)) {
                ...
                for (j.css("width", (o / k.outerWidth() * 100).toFixed(4) + "%"), h.min_j < h.max_j && j.attr("colspan", h.max_j - h.min_j + 1), h.min_i < h.max_i && j.attr("rowspan", h.max_i - h.min_i + 1), c = 1; c < i.length; c++) e = a(i[c]), "<br>" != e.html() && "" !== e.html() && (n += "<br>" + e.html()), e.remove();
                j.html(n), b.selection.setAtEnd(j.get(0)), b.selection.restore(), b.toolbar.enable();
                var p = m.find("tr:empty");
                for (c = p.length - 1; c >= 0; c--) f = a(p[c]), (0 === f.prev().length || 0 === f.next().length || f.prev().find("> th[rowspan], > td[rowspan]").length < f.prev().find("> th, > td").length) && f.remove();
                d()
            }
        }
        ...
        function H(b, c, d, e, f) {
            var g, h, i, j, k = b,
                ...
                m = d,
                n = e;
            for (g = k; l >= g; g++)((parseInt(a(f[g][m]).attr("rowspan"), 10) || 1) > 1 || (parseInt(a(f[g][m]).attr("colspan"), 10) || 1) > 1) && (i = C(f[g][m], f), j = D(i.row, i.col, f), k = Math.min(i.row, k), l = Math.max(j.row, l), m = Math.min(i.col, m), n = Math.max(j.col, n)), ((parseInt(a(f[g][n]).attr("rowspan"), 10) || 1) > 1 || (parseInt(a(f[g][n]).attr("colspan"), 10) || 1) > 1) && (i = C(f[g][n], f), j = D(i.row, i.col, f), k = Math.min(i.row, k), l = Math.max(j.row, l), m = Math.min(i.col, m), n = Math.max(j.col, n));
        ...
        function J(b, c) {
            if (a(b).is(c)) E(), a(b).addClass("fr-selected-cell");
            else {
                F();
                var d = B(),
                    e = C(b, d),
                ...
                for (var h = g.min_i; h <= g.max_i; h++)
                    for (var i = g.min_j; i <= g.max_j; i++) a(d[h][i]).addClass("fr-selected-cell")
            }
        }
        ...
        function L(c) {
            if (b.$el.find(".fr-selected-cell").length > 0 && !c.shiftKey && (E(), b.$el.removeClass("fr-no-selection"), b.edit.on()), 1 == c.which) {
                ha = !0;
                var d = K(c);
                if (d) {
                    ...
                    c.shiftKey && a(e + ".fr-selected-cell").length > 0 ? a(a(e + ".fr-selected-cell").closest("table")).is(a(d).closest("table")) ? J(ia, d) : F() : ((b.keys.ctrlKey(c) || c.shiftKey) && F(), ia = d, J(ia, ia))
                }
            }
        }
        ...
        function M(c) {
            if (1 == c.which) {
                if (ha = !1, ga) {
                    ga = !1;
                    var e = K(c);
                    e || 1 != b.$el.find(".fr-selected-cell").length ? b.$el.find(".fr-selected-cell").length > 0 && (b.selection.isCollapsed() ? d() : E()) : E()
                } else b.$tb.is(c.target) || b.$tb.is(a(c.target).closest(b.$tb.get(0))) || (b.$el.get(0).querySelectorAll(".fr-selected-cell").length > 0 && b.toolbar.enable(), E());
                if (ka) {
                    ...
                    b.opts.iframe && (f -= b.$iframe.offset().left), ea.data("release-position", f), ea.removeData("max-left"), ea.removeData("max-right"), X(c), Q()
                }
            }
        }
        ...
        function N(c) {
            if (ga === !0) {
                ...
                if (d.closest("table").is(b.$el.find(".fr-selected-cell").closest("table"))) {
                    if ("TD" == c.currentTarget.tagName && 0 === b.$el.find("th.fr-selected-cell").length) return void J(ia, c.currentTarget);
                    if ("TH" == c.currentTarget.tagName && 0 === b.$el.find("td.fr-selected-cell").length) return void J(ia, c.currentTarget)
                }
                F()
            }
        }
        ...
        function O(a) {
            (37 == a.which || 38 == a.which || 39 == a.which || 40 == a.which) && b.$el.find(".fr-selected-cell").length > 0 && (E(), b.popups.hide("table.edit"))
        }

        function P() {
            ea = a('<div class="fr-table-resizer"><div></div></div>'), b.$wp.append(ea), ea.on("mousedown", function () {
                ka = !0, ea.addClass("fr-moving"), E(), F(), ea.find("div").css("opacity", 1)
            }), b.events.on("destroy", function () {
                ea.off("mousedown"), ea.html("").removeData().remove()
            }, !0)
        }

        function Q() {
            ea.find("div").css("opacity", 0), ea.css("top", 0), ea.css("left", 0), ea.css("height", 0), ea.find("div").css("height", 0), ea.hide()
        }

        function R(c, d) {
            var e = a(d),
                f = e.closest("table");
            if (d && "TD" != d.tagName && "TH" != d.tagName && (e.closest("td").length > 0 ? d = e.closest("td") : e.closest("th").length > 0 && (d = e.closest("th"))), !d || "TD" != d.tagName && "TH" != d.tagName) e.get(0) != ea.get(0) && e.parent().get(0) != ea.get(0) && Q();
            else {
                if (e = a(d), 0 === b.$el.find(e).length) return !1;
                var g = e.offset().left - 1,
                    h = g + e.outerWidth();
                if (Math.abs(c.pageX - g) <= b.opts.tableResizerOffset || Math.abs(h - c.pageX) <= b.opts.tableResizerOffset) {
                    ...
                    if (o.col > 0 && c.pageX - g <= b.opts.tableResizerOffset) {
                        ...
                        l = 1 == (parseInt(s.attr("colspan"), 10) || 1) ? s.offset().left - 1 + b.opts.tableResizingLimit : g - Y(o.col - 1, n) + b.opts.tableResizingLimit, m = 1 == (parseInt(e.attr("colspan"), 10) || 1) ? g + e.outerWidth() - b.opts.tableResizingLimit : g + Y(o.col, n) - b.opts.tableResizingLimit, i = o.col - 1, j = o.col
                        ...
                        if (k = h, p.col < n[p.row].length && n[p.row][p.col + 1]) {
                            ...
                            i = p.col, j = null;
                            var u = f.parent();
                            l = f.offset().left - 1 + n[0].length * b.opts.tableResizingLimit, m = u.offset().left - 1 + u.width() + parseFloat(u.css("padding-left"))
                        }
        ...
        function T(c, d) {
            ...
            var e = a(d),
                ...
                g = 0,
                h = 0;
            b.opts.iframe && (g += b.$iframe.offset().left - a(b.original_window).scrollLeft(), h += b.$iframe.offset().top - a(b.original_window).scrollTop());
            var i;
        ...
        function U(c, d) {
            if (0 === b.$el.find(".fr-selected-cell").length) {
                var e, f, g;
                if (fa.removeClass("fr-visible"), d && ("HTML" == d.tagName || "BODY" == d.tagName || b.node.isElement(d)))
                    for (e = 1; e <= b.opts.tableInsertHelperOffset; e++) {
                        if (f = b.document.elementFromPoint(c.pageX - b.window.pageXOffset, c.pageY - b.window.pageYOffset + e), f && ("TH" == f.tagName || "TD" == f.tagName || "TABLE" == f.tagName) && a(f).parents(b.$wp).length) {
                            S(c, f.closest("table"));
                            break
                        }
                        if (g = b.document.elementFromPoint(c.pageX - b.window.pageXOffset + e, c.pageY - b.window.pageYOffset), g && ("TH" == g.tagName || "TD" == g.tagName || "TABLE" == g.tagName) && a(g).parents(b.$wp).length) {
                            T(c, g.closest("table"));
                            break
                        }
                    }
        ...
        function W() {
            if (ka) {
                var a = ea.data("table");
                ea.css("top", a.offset().top - b.window.pageYOffset)
            }
        }
        ...
        function aa(c) {
            ...
            if (d == a.FroalaEditor.KEYCODE.TAB && 0 === b.opts.tabSpaces) {
                var e;
                if (b.$el.find(".fr-selected-cell").length > 0) e = b.$el.find(".fr-selected-cell:last");
                else {
                ...
                e && (c.preventDefault(), E(), b.popups.hide("table.edit"), c.shiftKey ? e.prev().length > 0 ? _(e.prev()) : e.closest("tr").length > 0 && e.closest("tr").prev().length > 0 ? _(e.closest("tr").prev().find("td:last")) : e.closest("tbody").length > 0 && e.closest("table").find("thead tr").length > 0 && _(e.closest("table").find("thead tr th:last")) : e.next().length > 0 ? _(e.next()) : e.closest("tr").length > 0 && e.closest("tr").next().length > 0 ? _(e.closest("tr").next().find("td:first")) : e.closest("thead").length > 0 && e.closest("table").find("tbody tr").length > 0 ? _(e.closest("table").find("tbody tr td:first")) : (e.addClass("fr-selected-cell"), q("below"), E(), _(e.closest("tr").next().find("td:first"))), b.selection.restore())
            }
        }
        ...
        function ba() {
            fa = a('<div class="fr-insert-helper"><a class="fr-floating-btn" role="button" tabindex="-1" title="' + b.language.translate("Insert") + '"><svg viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg"><path d="M22,16.75 L16.75,16.75 L16.75,22 L15.25,22.000 L15.25,16.75 L10,16.75 L10,15.25 L15.25,15.25 L15.25,10 L16.75,10 L16.75,15.25 L22,15.25 L22,16.75 Z"/></svg></a></div>'), b.$box.append(fa), b.events.on("destroy", function () {
                ...
                a.stopPropagation()
            }), a(b.window).on("scroll.table" + b.id, function () {
                ...
                fa.off("mousemove"), a(b.window).off("scroll.table" + b.id)
            }, !0)
        }
        ...
        function ca() {
            return b.$wp ? (b.helpers.isMobile() || (ha = !1, ga = !1, ka = !1, P(), b.opts.tableInsertHelper && ba(), b.$el.on("mousedown.table" + b.id, L), b.popups.onShow("image.edit", function () {
            ...
            }), b.$el.on("mouseenter.table" + b.id, "th, td", N), b.$window.on("mouseup.table" + b.id, M), b.$el.on("keydown.table" + b.id, O), b.$window.on("mousemove.table" + b.id, $), a(b.window).on("scroll.table" + b.id, W), b.events.on("contentChanged", function () {
                ...
                if (b.$el.find(".fr-selected-cell").length > 0) {
                    ...
                    if (b.$el.find(".fr-selected-cell").length > 1) return c.preventDefault(), !1
                }
            }, !0), a(b.window).on("keydown.table" + b.id, d), a(b.window).on("input.table" + b.id, d), a(b.window).on("keyup.table" + b.id, d), b.events.on("html.get", function (a) {
        ...
        refresh: function (a) {
            a.find("> *:first").replaceWith(this.icon.create("align-" + this.helpers.getAlignment(this.$el.find(".fr-selected-cell:first"))))
        },
        refreshOnShow: function (a, b) {
